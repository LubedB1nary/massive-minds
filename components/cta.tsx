    ...
    >
      <div className="max-w-7xl mx-auto 0 flex flex-col md:flex-row justify-between items-center w-full">
        <div className="flex flex-col">
          ...
          Harness the power of AI to transform your marketing approach. Schedule a demo now and discover how our cutting-edge solutions can drive your business forward.
          </p>
          <FeaturedImages
