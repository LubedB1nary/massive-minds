...
export function Features() {
  return (
    ...
    >
      ...
      Transform campaigns with AI-driven strategies and deep insights.
      </p>
      <div className="mt-20  grid cols-1 md:grid-cols-5 gap-4 md:auto-rows-[25rem] max-w-7xl mx-auto">
        <Card className="flex flex-col justify-between md:col-span-3">
          ...
          <CardContent className="h-40">
            ...
            <CardDescription>
            Streamline with enterprise GitHub and AWS integration for quick setup.
            </CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            ...
            <CardDescription>
            Visualize complex data through our user-friendly interface.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            ...
            <CardDescription>
            Access worldwide market trends and consumer behavior patterns.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <SkeletonTwo />
        ...
        <Card className="flex flex-col justify-between md:col-span-3">
          <CardContent className="h-40">
            <CardTitle>Secure Data Upload</CardTitle>
            <CardDescription>
            Swiss protection laws safeguard your sensitive information.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <div className="w-full h-full p-4 rounded-lg bg-neutral-100 border border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700 ml-6 mt-2">
              <Image
                src="/Massive_Minds_collection.png"
                alt="Dashboard"
                width={500}
                height={500}
                className="w-full object-cover rounded-lg "
